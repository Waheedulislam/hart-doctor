...
import EnhancedCourseCard from "./CourseCard";
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
        <div className="text-center my-7 text-3xl">
          <p className="text-slate-600 dark:text-slate-400">
            <span className="text-teal-700 font-bold ">{courses.length}</span>{" "}
            {courses.length === 1 ? "review" : "reviews"} from our valued
            customers
          </p>
        </div>
